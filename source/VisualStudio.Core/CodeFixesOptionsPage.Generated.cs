...
namespace Roslynator.VisualStudio
{
    public partial class CodeFixesOptionsPage
    {
        ...
        protected override void Fill(ICollection<BaseModel> codeFixes)
        {
            ...
            codeFixes.Add(new BaseModel(CodeFixIdentifiers.AddArgumentList, "Add argument list (fixes CS0023, CS0428, CS0201)", IsEnabled(CodeFixIdentifiers.AddArgumentList)));
